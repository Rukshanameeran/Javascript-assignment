console.log("To take 2 arrays from the user and check if the number 4 exists in any of the arrays");
console.log("--------------------------------------------------------------------------")
//input1
// let arr1=[1,2,3,4,5]
// let arr2=[ 4, 6, 1, 8, 2 ]
...
// arrchk([1,2],[3,4]);
arrchk([1,2,3,4,5],[ 4, 6, 1, 8, 2 ])
console.log("\n")
arrchk([1, 2, 3, 6, 5 ],[4, 6, 1, 8, 2 ])
console.log("\n")
arrchk([1,2,3,4,5 ],[ 5,6,1,8,2])